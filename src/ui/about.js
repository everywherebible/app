...
export default () => (
  <div
    ...
    <div style={{marginTop: "-3rem", textAlign: "justify"}}>
      ...
      <p>
        Developed by <a href={REPO}>Aaron Stacy</a> and released under{" "}
        <a href={REPO + "/blob/dev/LICENSE"}>the {pkg.license} License</a>.
      </p>
      ...
      <p style={{fontSize: SMALL_FONT}}>
        ...
        <a href="http://www.esvapi.org/#copyright">permission</a>. All rights
